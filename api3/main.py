...
@app.route('/apiz/csv', methods=['POST'])
def recibir_csv():
    global df
    global midf
    global usuariosp
    if request.method == 'POST':
        ...
        sep2 = rae.query('userId in @user_part_3')
        ...
        redis_conn.set('lsrae3', json.dumps(diccionario2))
        

        
        return jsonify({"mensaje": "csv cargado correctamente a redis 3"})
    else:

...
@app.route('/apib/csv', methods=['POST'])
def recibir_csv():
    global df
    global midf
    global usuariosp
    if request.method == 'POST':
        ...
        sep2 = rae.query('userId in @user_part_5')
        ...
        redis_conn.set('lsrae5', json.dumps(diccionario2))
        

        
        return jsonify({"mensaje": "csv cargado correctamente a redis 5"})
    else:
